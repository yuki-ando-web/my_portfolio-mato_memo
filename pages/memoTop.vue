        ...
        <v-container>
            <v-row>
              ...
              <v-col>
                <v-card height="100%">
                  <div>
                    <v-textarea auto-grow dense height="64vh" loader-height=""
                  full-width loading></v-textarea>
                  </div>
...
export default {
  data() {
    return {
      memos: [
        { title: 'タイトル１', content: 'bbbbbb' },
        { title: 'タイトル２', content: 'sddddd' },
        { title: 'タイトル３', content: 'sddddd' },
        { title: 'タイトル３', content: 'sddddd' },
        { title: 'タイトル３', content: 'sddddd' },
        { title: 'タイトル３', content: 'sddddd' },
        { title: 'タイトル３', content: 'sddddd' },
